...
class Retention_devideModel2 extends XoaModel
{
    ...
    function insertSumData2($arr)
    {
        ...
        $sql .=' sum(numchar_a30) numchar_a30, sum(numchar_b30) numchar_b30, sum(numchar_c30) numchar_c30, sum(numchar_a60) numchar_a60, sum(numchar_b60) numchar_b60, sum(numchar_c60) numchar_c60 from retention_device2';
    ...
    function getRetention($time_start = '', $time_end = '')
    {
        ...
        $sql1 = "select * from retention_device2 where 1=1 ";
        $sql2 = " ";
    ...
    {
        $rdtm = new RetentionDeviceTaskModel2;
