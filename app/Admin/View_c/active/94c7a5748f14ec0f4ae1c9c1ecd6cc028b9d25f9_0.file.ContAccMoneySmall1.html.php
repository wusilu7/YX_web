<?php
/* Smarty version 3.1.30, created on 2024-03-29 11:53:23
  from "/lnmp/www/app/Admin/View/active/ContAccMoneySmall1.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_66063b333cfe33_41918432',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '94c7a5748f14ec0f4ae1c9c1ecd6cc028b9d25f9' => 
    array (
      0 => '/lnmp/www/app/Admin/View/active/ContAccMoneySmall1.html',
      1 => 1678771397,
      2 => 'file',
    ),
  ),
...
function content_66063b333cfe33_41918432 (Smarty_Internal_Template $_smarty_tpl) {
$_smarty_tpl->_subTemplateRender("file:../common/1header.html", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array(), 0, false);
?>

<div class="jin-content-title"><span>祈福(铲子)</span></div>
<div class="alert alert-info">
    ...
    <!--<label for="sign" style="font-size: 18px;color: #eee;margin-bottom: 0;">子活动：</label>-->
    <select class="hide"  id="at_type" style="padding: 5px;">
        <option value="64">新服</option>
        <option value="64">老服</option>
    </select>
    ...
    <button id="jin_copy" class="btn btn-primary">复制活动到指定渠道</button>
...
<!--<label for="new_old" style="font-size: 18px;margin-bottom: 0;">新服老服区分：</label>-->
<!--<input id="new_old" type="text"  style="width: 50px;">*输入3代表发送时间的当天0点减去3天之前开的服为老服,其余为新服-->
...
<?php echo '<script'; ?>
 type="text/javascript">
    ...
    var id_check = function (json) {
        return '<input type="checkbox" value="'+json.id_checkbox+'" />'+json.id_checkbox
    };
    ...
    var arr = [id_check,'AccMoneyCount','AccMoneyReward','ContDay','AccMoneyNum','DayAccMoneyReward',Send_si,'send_time',btn];
    // 普通查询
    ...
    $('#content').on('click', 'a[data-type="update"]', function() {
        ...
        window.open(location.href + '&jinIf=919&gi='+$("#group").val()+'&sign='+$("#sign").val()+'&id=' + id+'&at_type='+$("#at_type").val());
        return false;
