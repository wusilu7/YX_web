<?php
/* Smarty version 3.1.30, created on 2024-08-15 10:53:38
  from "D:\pro\WebSiteYiXing\app\Admin\View\active\updatePaygift.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_66bd6db2b6a248_55198077',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '34fb94b69a91ec4140ab29fc8054bbf79d25f5e5' => 
    array (
      0 => 'D:\\pro\\WebSiteYiXing\\app\\Admin\\View\\active\\updatePaygift.html',
      1 => 1723690417,
      2 => 'file',
    ),
  ),
...
function content_66bd6db2b6a248_55198077 (Smarty_Internal_Template $_smarty_tpl) {
...
"+$(this).val()+".png");
    ...
    $('button[data-type="update"]').on('click', function () {//修改服务器
        if(UpdateTime==$("#UpdateTime").val()){
            layer.alert('请确认UpdateTime选项是否需要+1？', {icon: 0, shadeClose: true, btn: ['不需要', '需要']}, function (index) {
                layer.close(index);
                all_update();
            });
        }else{
