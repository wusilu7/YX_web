<?php
/* Smarty version 3.1.30, created on 2024-04-24 18:13:16
  from "D:\pro\WebSiteYiXing\app\Admin\View\operation\SKU.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_6628db3c8b3413_73095835',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'e4661eff1a8a0bc58f46e7565c001e26996294ea' => 
    array (
      0 => 'D:\\pro\\WebSiteYiXing\\app\\Admin\\View\\operation\\SKU.html',
      1 => 1704262932,
      2 => 'file',
    ),
  ),
...
function content_6628db3c8b3413_73095835 (Smarty_Internal_Template $_smarty_tpl) {
...
<div class="jin-content-title"><span>SKU</span></div>
...
<div class="jin-server-select">
    ...
    <select id="type" style="padding: 6px 5px;">
        ...
        <option value="11">安卓</option>
        <option value="7">引擎</option>
    </select>
 ...
 type="text/javascript">
        ...
        $("#jin_add").on('click', function () {
            ...
            layer.open({
                ...
                '<div class="input-group"><span class="input-group-addon">SKU</span><textarea id="content1"  rows="7"  class="form-control"></textarea></div>' +
                '</div>' +
                '</div>',
                yes: function (index1) {
                    $.ajax({
        ...
        $('#content').on('click', 'a[data-type="update"]', function() {
            ...
            layer.open({
                ...
                content:'<div class="jin-child">' +
                '<div class="select_group_div">'+
                '<div class="input-group"><span class="input-group-addon">sku</span><textarea id="content1"  rows="7"  class="form-control">'+content+'</textarea></div>' +
                '</div>' +
                '</div>',
                yes: function (index1) {
                    $.ajax({
