<?php
/* Smarty version 3.1.30, created on 2024-04-24 18:07:36
  from "D:\pro\WebSiteYiXing\app\Admin\View\data1\selectTotal.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_6628d9e8682275_63740775',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '1a8164102dcba7928dddf3af827a34bbaa3cc1d8' => 
    array (
      0 => 'D:\\pro\\WebSiteYiXing\\app\\Admin\\View\\data1\\selectTotal.html',
      1 => 1704262932,
      2 => 'file',
    ),
  ),
...
function content_6628d9e8682275_63740775 (Smarty_Internal_Template $_smarty_tpl) {
$_smarty_tpl->_subTemplateRender("file:../common/1header.html", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array(), 0, false);
?>

<!--|↓↓↓↓↓↓|-->
<div class="jin-content-title"><span>数据汇总</span></div>
...
<?php echo '<script'; ?>
 type="text/javascript">
    gsSelect('#group', '#server', '#platform', getTotal);
    calendar('month', '#time_start', '#time_end');
    var url = location.href + "&jinIf=912";
    var arr = ['groupname','servername', 'dc', 'ac', 'bn','bc','pur','arpu','arppu','open_time'];
    var id = ["#content", "#page"];
    var data = {};
    function getTotal() {
        data.page       = 1;
