<?php
/* Smarty version 3.1.30, created on 2024-01-19 09:16:02
  from "C:\Users\Administrator\Desktop\pro\WebSiteYiXing\app\Admin\View\data1\selectPower.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_65a9cd520bdc85_22801478',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '8bd40f8b6c836b9dee10124000e681cb9ac00ed0' => 
    array (
      0 => 'C:\\Users\\Administrator\\Desktop\\pro\\WebSiteYiXing\\app\\Admin\\View\\data1\\selectPower.html',
      1 => 1704262932,
      2 => 'file',
    ),
  ),
...
function content_65a9cd520bdc85_22801478 (Smarty_Internal_Template $_smarty_tpl) {
...
>
    ...
    var arr = ['rank', char_name,'char_id', 'acc_name', 'level','allfee','power','dtime',btn];
    var data = {};
    ...
    $('#content').on('click', 'a[data-type=sign]', function() {
        ...
        $.ajax({
            ...
            success: function (json) {
                ...
                c+='<tr>' +
                    '<td style="color: #ff5155">剩余体力</td>' +
                    '<td>'+json['base_info']['gold']+'</td>' +
                    '</tr>';
                c+='<tr>' +
                    '<td  style="color: #ff5155">剩余珍珠</td>' +
