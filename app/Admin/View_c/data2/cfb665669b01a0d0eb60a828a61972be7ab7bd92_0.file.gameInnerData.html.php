<?php
/* Smarty version 3.1.30, created on 2024-04-24 17:51:52
  from "D:\pro\WebSiteYiXing\app\Admin\View\data2\gameInnerData.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_6628d638723a51_42987634',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'cfb665669b01a0d0eb60a828a61972be7ab7bd92' => 
    array (
      0 => 'D:\\pro\\WebSiteYiXing\\app\\Admin\\View\\data2\\gameInnerData.html',
      1 => 1713952306,
      2 => 'file',
    ),
  ),
...
function content_6628d638723a51_42987634 (Smarty_Internal_Template $_smarty_tpl) {
...
<!--|↓↓↓↓↓↓|-->
<div class="jin-content-title"><span>局内数据</span></div>
...
<div class="jin-search-div">
    ...
    <div>
        ...
        <input id="stage_id" type="text" class="form-control jin-search-input" placeholder="章节id">
        ...
        <select  id="DieType" class="form-control jin-search-input">
            <option value="">退出类型</option>
            <option value="0">死亡</option>
            <option value="1">通关</option>
            <option value="2">退出</option>
            <option value="3">切换账号</option>
        </select>
...
<div class="table-responsive">
    <table class="table table-striped text-center">
        ...
        <tr>
            ...
            <th>天赋等级</th>
            <th>装备/技能信息</th>
            <th style="display: none">装备信息</th>
            <th style="display: none">技能信息</th>
        </tr>
        </thead>
...
<?php echo '<script'; ?>
>
    var zhuangbeiinfo = function (json) {
        var str = json.EquipInfo.substring(0,5);
    ...
    $("#content").on('click', 'button[data-type="u"]', function () {
        var zhuangbei = $(this).parents('tr').find('td').eq(20).text();
        var jineng = $(this).parents('tr').find('td').eq(21).text();
        ...
        layer.open({
            ...
            content: '<div class="tab-content">' +
                ...
                '<div class="input-group"><span class="input-group-addon">装备信息</span><textarea id="content0"  rows="10"  class="form-control">' + zhuangbei + '</textarea></div><br>' +
    ...
    var arr = ['log_time', 'account', 'char_guid', 'char_name', 'Level', 'StageID', 'Layer','MaxStageID', 'MaxLayer', 'DieType','RoomID', 'BrushMonsterID','MapID','AttactG','Attact','MaxHPG','MaxHP','Fight','TalentLevel',btn,zhuangbeiinfo,jinenginfo];
